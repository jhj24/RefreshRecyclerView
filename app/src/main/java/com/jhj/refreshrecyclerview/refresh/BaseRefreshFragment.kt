...
abstract class BaseRefreshFragment<T> : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        this.mView = view
        inputManager = requireActivity().getSystemService(Activity.INPUT_METHOD_SERVICE) as InputMethodManager
        initParam()
        ...
        //其他条件筛选
        if (filterSearch) {
            view.layout_action_search.visibility = View.VISIBLE
            filterSearch()
        } else {
            view.layout_action_search.visibility = View.GONE
        }
        ...
        //重新加载
        view.tv_refresh_new.setOnClickListener {
            view.layout_refresh_new.visibility = View.GONE
    ...
    private fun initAdapter(): SlimAdapter {
        ...
        return SlimAdapter.creator(LinearLayoutManager(requireContext()))
            ...
            .enqueue(object : BaseHttpCallback<RefreshResult<T>>() {
                ...
                override fun onFinish() {
                    ...
                    if (adapterLocal.dataList == null || adapterLocal.dataList?.size == 0) {
                        mView.layout_refresh_new.visibility = View.VISIBLE
                        mView.smartRefreshLayout.visibility = View.GONE
                        if (isSuccess) {
                        ...
                        mView.layout_refresh_new.visibility = View.GONE
                        mView.smartRefreshLayout.visibility = View.VISIBLE
                    }
                }
    ...
    private fun inputSearch() {
        ...
        mView.layout_search_mark.setOnTouchListener { _, _ ->
            ...
            inputManager.showSoftInput(mView.et_search_input, 0)
            return@setOnTouchListener false
        }
        ...
        mView.et_search_input.setOnEditorActionListener { _, actionId, _ ->
            if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                inputManager.hideSoftInputFromWindow(mView.et_search_input.windowToken, 0)
                when {
    ...
    private fun filterSearch() {
        val dialog = AlertFragment.Builder(requireContext())
